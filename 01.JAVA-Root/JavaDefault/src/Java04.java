...
Scanner myObj = new Scanner(System.in)) {
    ...
    // nextTime() 메서드로 입력 라인 전체를 가져옴
    // next() 메서드는 단어 하나를 가져옴(띄어쓰기 맨앞단어만)
...
//   else : 모든 조건에 해당없을 경우 실행할 코드
 ...
 System.out.println("오늘은 당신의 생일인가요?(예/아니요)");
 String birth = myObj.nextLine();
 System.out.println();
 System.out.println(birth.equals("예")?"생일축하해요":"오늘도 행복하세요");
...
switch(menu){
    ...
    break;
    case 3:
    System.out.println("돈까스먹ㄱㄱ거ㅓ");
    break;
    case 4:
    System.out.println("비빔ㅁㅁㅁㅁㅁㅁ");
    break;
    default:
    System.out.println("기타ㅏㅏㅏㅏㅏㅏ");
    break;
}//// switch //////////////
