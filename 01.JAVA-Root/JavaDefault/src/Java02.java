...
/************************************************* */
       ...
       // float이나 double은 근사값이므로 끝자리가 달라질 수 있음
       double numDouble = 7.123456789123456789D; // 결과: 7.123456789123456
 ...
 /*            2. 기본이 아닌 데이터 유형
        ...
        *****************************************************************/
         ...
         */
         ...
         // 1. 업캐스팅 : 자동형변환됨
         int muInt = 9;
         double myDouble = muInt;

         System.out.println();
         System.out.println("형변환:업캐스팅");
         System.out.println("int값: "+muInt);
         System.out.println("int를 double로: "+myDouble);

         // 2. 다운캐스팅 : 할당할 변수타입과 같은 타입을 소괄호에 씀
         // 타입 변수 = (변환타입) 변수
